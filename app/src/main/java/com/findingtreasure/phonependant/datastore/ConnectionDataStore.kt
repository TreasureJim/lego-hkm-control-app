...
val Context.dataStore: androidx.datastore.core.DataStore<Preferences> by preferencesDataStore(name = "connection")
...
class ConnectionDataStore(private val context: Context) {
    ...
    val isRememberMe: Flow<Boolean> = context.dataStore.data.map { preferences ->
